...
vec3 baseColor = vec3(0.051890, 0.296060, 0.425324);
float metallic = 0.000000;
float roughness = 0.400000;
float anisotropic = 0.500000;
float specular = 0.500000;
float specularTint = 0.000000;
float sheen = 0.000000;
float sheenTint = 0.500000;
float clearcoat = 1.000000;
...
surfaceshader mtlxHostEvalSurface()
{
    ...
    NG_disney_principled(baseColor, metallic, roughness, anisotropic, specular, specularTint, sheen, sheenTint, clearcoat, clearcoatGloss, specTrans, ior, subsurface, subsurfaceDistance, SR_carpaint_out);
    return SR_carpaint_out;
}
