...
vec3 base_color = vec3(0.150000, 0.550000, 0.300000);
...
// Generated pathtracer dispatch (feature 003). Model: gltf_pbr
...
vec3 sampleBsdf(in vec3 pW, in Basis basis, in vec3 winputL, inout uint rndSeed, in int material, out vec3 woutputL, out float pdf_woutputL, out Volume internal_medium)
{
    ...
    vec3  m_transC = attenuation_color;
    float m_transD = attenuation_distance;
