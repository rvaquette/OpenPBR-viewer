...
vec3 diffuseColor = vec3(0.051890, 0.296060, 0.425324);
...
float clearcoatRoughness = 0.000000;
...
surfaceshader mtlxHostEvalSurface()
{
    ...
    IMP_UsdPreviewSurface_surfaceshader(diffuseColor, emissiveColor, useSpecularWorkflow, specularColor, metallic, roughness, clearcoat, clearcoatRoughness, opacity, opacityMode, opacityThreshold, ior, normal, displacement, occlusion, SR_carpaint_out);
