...
vec3 base_color = vec3(0.912000, 0.914000, 0.920000);
float base_diffuse_roughness = 0.000000;
float base_metalness = 1.000000;
float specular_weight = 1.000000;
vec3 specular_color = vec3(0.970000, 0.979000, 0.988000);
float specular_roughness = 0.200000;
float specular_ior = 1.500000;
float specular_roughness_anisotropy = 0.900000;
